...
# Test data paths
TEST_DATA_FOLDER = Path(__file__).resolve().parent.parent.parent.parent / "test_data" / "transliteration"
TYPING_TEST_DATA_FOLDER = Path(__file__).resolve().parent.parent.parent.parent / "test_data" / "typing"
