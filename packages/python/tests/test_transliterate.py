...
# Test data folder
TEST_DATA_FOLDER = (
    Path(__file__).parent.parent.parent.parent / "test_data" / "transliteration"
)
...
class TestTransliteration:
    ...
    def test_transliteration_from_yaml(self, yaml_file: Path):
        ...
        # Skip ignored files
        if (
            str(relative_path) in TEST_FILES_TO_IGNORE
            or file_name in TEST_FILES_TO_IGNORE
        ):
