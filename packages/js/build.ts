...
async function main() {
  ...
  runStep(
    '.d.ts file unification (index)',
    'bun',
    ['api-extractor', 'run', '--local', '--config', 'scripts/api-extractor.json'],
    {
      cwd: packageRoot,
      quiet: true
    }
  ...
  runStep(
    '.d.ts file unification (typing)',
    'bun',
    ['api-extractor', 'run', '--local', '--config', 'scripts/api-extractor.typing.json'],
    {
      cwd: packageRoot,
      quiet: true
    }
