...
- There will be a different set of keys alongside the existing one to enable language typing. Like for क्ष -> kSh.
...
- Make a test to convert Normal to all other scripts. As in typing the Normal to Other Script transliteration will be used.
