...
use super::generated;
use super::schema::{CommonScriptAttr, ScriptDataParsed};
...
static SCRIPT_DATA_CACHE: OnceLock<HashMap<String, ScriptDataParsed>> = OnceLock::new();
impl ScriptDataParsed {
  fn load_all() -> HashMap<String, ScriptDataParsed> {
    ...
    for &script_name in generated::SCRIPT_DATA_NAMES {
      ...
      let data: ScriptDataParsed = bincode::deserialize(bytes)
  ...
  pub fn get_script_data(script: &str) -> &'static ScriptDataParsed {
  ...
  fn all_script_data_json_files_must_parse() {
    ...
    for entry in entries {
      ...
      if path.extension().and_then(|e| e.to_str()) == Some("json") {
        ...
        let _ = ScriptDataParsed::get_script_data(script_name);
      }
    }
  }
}
