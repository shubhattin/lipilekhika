<script lang="ts">
  ...
  const filterCategory = (
    ...
    if (category === "vyanjana")
      return items.filter(([, t]) => t === "vyanjana");
        ...
        <Tabs.Root value="typing-map" class="flex h-full min-h-0 flex-col">
          ...
          <Tabs.Content value="typing-map" class="mt-4 flex-1 pr-1">
            ...
            {:then script_typing_map}
              ...
              {@const specific =
                script_typing_map.script_specific_krama_map as Item[]}
                  ...
                  >
                    {#each vyanjanaItems as [char, type, mappings] (char + type)}
                      ...
                      >
                        ...
                        <div
                          class="mt-1 flex max-h-20 flex-wrap gap-1 overflow-auto pr-1"
                        >
                          {#each mappings as m (m)}
                            <Badge
                              variant="outline"
            ...
            <div class="space-y-4">
              ...
              >
                <div class="text-sm text-muted-foreground">
                  Current script: <span class="font-medium text-foreground"
                    >{script}</span
                  >
                </div>
              ...
              {#if !script_to_compare}
                ...
                >
                  Select a script to compare against <span class="font-medium"
                    >{script}</span
                  >.
                </div>
              {:else}
                {@const compareProm = script_to_compare_krama_prom as Promise<
                  KramaRow[]
                >}
                ...
                {:catch err}
                  ...
                  >
                    <p class="font-medium text-destructive">
                      Could not load script comparison
                    </p>
