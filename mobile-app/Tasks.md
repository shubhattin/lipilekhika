...
- [ ] Bundle Noto Sans (google_fonts) + Satisar Sharada
- [ ] Use Proper Icons
- [ ] Have Online App and Gihub Link on the menu
...
- [ ] Release Basic Version for Closed Testing when
  - [ ] App Icon and splashscreen handling
  - [ ] Correct Icon and Link handling
  - [ ] Correct Custom Option Descriptions
  - [ ] Display version number correct in about section of the app